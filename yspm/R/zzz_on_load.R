...
.onLoad <- function(lib, pkg) {
  ...
  .yspm.env$.yspm.project_structure <- list(
    ...
    file_metadata_project = "project/metadata/package/project.dcf",
    file_metadata_license = "project/metadata/package/license.dcf",
    ...
    file_workflow_packages = "project/source/library/00_packages.R",
